...
**Most recent rehearsal:** 2026-09-19, runs [35403751647](https://github.com/DanBeckDev/a11ign-v1-rehearsal/actions/runs/35403751647) and [35403758080](https://github.com/DanBeckDev/a11ign-v1-rehearsal/actions/runs/35403758080), against `17beb451a` — main, four days of ordinary merges past rehearsal 5's candidate, touching source in all five published packages. Two completed runs on the documents' recommended page and task, jobs 5 m 54 s and ~6 m; 141 announcements each, `jq -c .transcript a11ign-result.json | sha256sum` = `6c040860…` for both and for rehearsal-4/5's own recorded hash, so the release candidate behaves as the rehearsed one did; 0 lived-experience findings, 3 axe violations inside the YouTube embed. Reading: ceo, #1723.
