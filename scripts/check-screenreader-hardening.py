...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=ROOT / "runs/screenreader-hardening.json")
...
def main() -> None:
    ...
    acceptance_paths = args.acceptance_data or [
        ROOT / "runs/screenreader-acceptance/screenreader-evidence.jsonl",
        ROOT / "runs/screenreader-acceptance/repeat-1.jsonl",
        ROOT / "runs/screenreader-acceptance/repeat-2.jsonl",
    ]
    acceptance = []
