...
//
//   node scripts/board-discussion.mjs --exists     the workflow's republish precondition
...
function main() {
  refuseUnknownFlags(["--exists"], { entry: import.meta.url, command: "node scripts/board-discussion.mjs" });
  if (!process.argv.includes("--exists")) {
    console.error("usage: node scripts/board-discussion.mjs --exists");
