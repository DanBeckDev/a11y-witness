...
// `1.3.5` JOINED ON 2026-09-09 (#869, issue #79), for the identical reason 1.4.13 above joined:
// `modelHead: false`, no head has ever shipped, and membership is derived from `decidedBy`/`reportsAs`
// rather than from whether a head currently exists.
