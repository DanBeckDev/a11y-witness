...
// `row-claim.mjs`'s own `defaultRun`, the one function that spawns a real `gh`. The marker stands alone on its
// line because `acceptance-commands.mjs`'s `NO_TOKEN_HEADER` ends at the name.
/**
