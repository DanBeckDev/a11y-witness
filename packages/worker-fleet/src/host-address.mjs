 ...
 * for every other network. Measured: against a bare-metal worker at REDACTED-INTERNAL-ADDRESS it produced
 * `http://REDACTED-INTERNAL-ADDRESS:5050` — the ROUTER — so `evidence:check` refused to run because the pages
