...
/**
 * WHAT THIS GUARD READS, declared so a diff outside it does not run it -- #929. It reads the capture-body owners under `packages/lab/src` and nothing else outside its own imports.
