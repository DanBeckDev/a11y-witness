...
| [`docs/README.md`](docs/README.md) | the index to every guide and runbook, grouped by task, with [`docs/adr/README.md`](docs/adr/README.md) for the 24 decision records |
...
It pushes **every hashed file** (26 now, defined once in `packages/nvda-worker/src/worker-files.mjs` — the
