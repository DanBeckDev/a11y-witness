...
## OPEN — "a check that answers correctly about the wrong population", **TWELVE** instances, named by `ceo`
...
was four for about six hours** — instances 5-12 were all found afterwards, none of them by the probes that
sweep used. Six of the eight were `orchestrator`'s own, one of them committed while writing this row.
