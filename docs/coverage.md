...
| state | count | meaning |
|---|---|---|
| **assessed** | 9 | a finding can be produced today |
| **partial** | 5 | assessed, but a named failure mode of it is not covered |
...
| **3.3.2** | Labels or Instructions | A | `unnamed-form-field` rules; rest: trained scorer | Unlabelled fields and placeholder-only labels. |
