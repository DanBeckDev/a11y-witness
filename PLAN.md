...
- [ ] **Extend part 2.** Add a bad-disclosure fixture (reveals content but does not announce "expanded") to exercise the judge on the failure case, and form-fill + submit to capture error/status announcements (3.3.1, 4.1.3).
